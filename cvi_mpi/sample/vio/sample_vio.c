...
//            }
        ...
        SAMPLE_PRT("Exit signal received, leaving grab/send loop...\n");
...
CVI_S32 SAMPLE_VIO_DualVpssChn_(void)
{
    COMPRESS_MODE_E    enCompressMode   = COMPRESS_MODE_NONE;
    VB_CONFIG_S        stVbConf;
    PIC_SIZE_E         enPicSize;
...
CVI_S32 SAMPLE_VIO_ViVpssAspectRatio(void)
{
	...
	astVpssChnAttr[VpssChn].u32Width                    = 368;
	astVpssChnAttr[VpssChn].u32Height                   = 552;
	astVpssChnAttr[VpssChn].enVideoFormat               = VIDEO_FORMAT_LINEAR;
