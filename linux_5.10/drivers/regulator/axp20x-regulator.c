...
#define AXP2101_DCDC1_V_OUT_MASK	GENMASK(4, 0)
#define AXP2101_DCDC234_V_OUT_MASK	GENMASK(6, 0)
#define AXP2101_DCDC5_V_OUT_MASK	GENMASK(4, 0)
#define AXP2101_LDO_V_OUT_MASK		GENMASK(4, 0)

#define AXP2101_PWR_OUT_DCDC1_MASK	BIT_MASK(0)
#define AXP2101_PWR_OUT_DCDC2_MASK	BIT_MASK(1)
#define AXP2101_PWR_OUT_DCDC3_MASK	BIT_MASK(2)
#define AXP2101_PWR_OUT_DCDC4_MASK	BIT_MASK(3)
#define AXP2101_PWR_OUT_DCDC5_MASK	BIT_MASK(4)

#define AXP2101_PWR_OUT_ALDO1_MASK	BIT_MASK(0)
#define AXP2101_PWR_OUT_ALDO2_MASK	BIT_MASK(1)
#define AXP2101_PWR_OUT_ALDO3_MASK	BIT_MASK(2)
#define AXP2101_PWR_OUT_ALDO4_MASK	BIT_MASK(3)
#define AXP2101_PWR_OUT_BLDO1_MASK	BIT_MASK(4)
#define AXP2101_PWR_OUT_BLDO2_MASK	BIT_MASK(5)
#define AXP2101_PWR_OUT_CPUSLDO_MASK	BIT_MASK(6)
#define AXP2101_PWR_OUT_DLDO1_MASK	BIT_MASK(7)
#define AXP2101_PWR_OUT_DLDO2_MASK	BIT_MASK(0)

#define AXP2101_DCDC23_500mV_START	0x00
#define AXP2101_DCDC23_500mV_STEPS	70
#define AXP2101_DCDC23_500mV_END	\
	(AXP2101_DCDC23_500mV_START + AXP2101_DCDC23_500mV_STEPS)
#define AXP2101_DCDC23_1220mV_START	0x47
#define AXP2101_DCDC23_1220mV_STEPS	16
#define AXP2101_DCDC23_1220mV_END	\
	(AXP2101_DCDC23_1220mV_START + AXP2101_DCDC23_1220mV_STEPS)
#define AXP2101_DCDC23_NUM_VOLTAGES	88

#define AXP2101_DCDC4_500mV_START	0x00
#define AXP2101_DCDC4_500mV_STEPS	70
#define AXP2101_DCDC4_500mV_END		\
	(AXP2101_DCDC4_500mV_START + AXP2101_DCDC4_500mV_STEPS)
#define AXP2101_DCDC4_1220mV_START	0x47
#define AXP2101_DCDC4_1220mV_STEPS	31
#define AXP2101_DCDC4_1220mV_END	\
	(AXP2101_DCDC4_1220mV_START + AXP2101_DCDC4_1220mV_STEPS)
...
static const struct linear_range axp2101_dcdc23_ranges[] = {
	REGULATOR_LINEAR_RANGE(500000,
			       AXP2101_DCDC23_500mV_START,
			       AXP2101_DCDC23_500mV_END,
			       10000),
	REGULATOR_LINEAR_RANGE(1220000,
			       AXP2101_DCDC23_1220mV_START,
			       AXP2101_DCDC23_1220mV_END,
			       20000),
};

static const struct linear_range axp2101_dcdc4_ranges[] = {
	REGULATOR_LINEAR_RANGE(500000,
			       AXP2101_DCDC4_500mV_START,
			       AXP2101_DCDC4_500mV_END,
			       10000),
	REGULATOR_LINEAR_RANGE(1220000,
			       AXP2101_DCDC4_1220mV_START,
			       AXP2101_DCDC4_1220mV_END,
			       20000),
};

static const struct regulator_desc axp2101_regulators[] = {
	AXP_DESC(AXP2101, DCDC1, "dcdc1", "vin1", 1500, 3400, 100,
		 AXP2101_DCDC1_V_OUT, AXP2101_DCDC1_V_OUT_MASK,
		 AXP2101_PWR_CTRL, AXP2101_PWR_OUT_DCDC1_MASK),
	AXP_DESC_RANGES(AXP2101, DCDC2, "dcdc2", "vin2",
			axp2101_dcdc23_ranges, AXP2101_DCDC23_NUM_VOLTAGES,
			AXP2101_DCDC2_V_OUT, AXP2101_DCDC234_V_OUT_MASK,
			AXP2101_PWR_CTRL, AXP2101_PWR_OUT_DCDC2_MASK),
	AXP_DESC_RANGES(AXP2101, DCDC3, "dcdc3", "vin3",
			axp2101_dcdc23_ranges, AXP2101_DCDC23_NUM_VOLTAGES,
			AXP2101_DCDC3_V_OUT, AXP2101_DCDC234_V_OUT_MASK,
			AXP2101_PWR_CTRL, AXP2101_PWR_OUT_DCDC3_MASK),
	AXP_DESC_RANGES(AXP2101, DCDC4, "dcdc4", "vin4",
			axp2101_dcdc4_ranges, AXP2101_DCDC4_NUM_VOLTAGES,
			AXP2101_DCDC4_V_OUT, AXP2101_DCDC234_V_OUT_MASK,
			AXP2101_PWR_CTRL, AXP2101_PWR_OUT_DCDC4_MASK),
	AXP_DESC(AXP2101, DCDC5, "dcdc5", "vin5", 1400, 3700, 100,
		 AXP2101_DCDC5_V_OUT, AXP2101_DCDC5_V_OUT_MASK,
		 AXP2101_PWR_CTRL, AXP2101_PWR_OUT_DCDC5_MASK),
	AXP_DESC(AXP2101, ALDO1, "aldo1", "aldoin", 500, 3500, 100,
		 AXP2101_ALDO1_V_OUT, AXP2101_LDO_V_OUT_MASK,
		 AXP2101_LDO_ONOFF0, AXP2101_PWR_OUT_ALDO1_MASK),
	AXP_DESC(AXP2101, ALDO2, "aldo2", "aldoin", 500, 3500, 100,
		 AXP2101_ALDO2_V_OUT, AXP2101_LDO_V_OUT_MASK,
		 AXP2101_LDO_ONOFF0, AXP2101_PWR_OUT_ALDO2_MASK),
	AXP_DESC(AXP2101, ALDO3, "aldo3", "aldoin", 500, 3500, 100,
		 AXP2101_ALDO3_V_OUT, AXP2101_LDO_V_OUT_MASK,
		 AXP2101_LDO_ONOFF0, AXP2101_PWR_OUT_ALDO3_MASK),
	AXP_DESC(AXP2101, ALDO4, "aldo4", "aldoin", 500, 3500, 100,
		 AXP2101_ALDO4_V_OUT, AXP2101_LDO_V_OUT_MASK,
		 AXP2101_LDO_ONOFF0, AXP2101_PWR_OUT_ALDO4_MASK),
	AXP_DESC(AXP2101, BLDO1, "bldo1", "bldoin", 500, 3500, 100,
		 AXP2101_BLDO1_V_OUT, AXP2101_LDO_V_OUT_MASK,
		 AXP2101_LDO_ONOFF0, AXP2101_PWR_OUT_BLDO1_MASK),
	AXP_DESC(AXP2101, BLDO2, "bldo2", "bldoin", 500, 3500, 100,
		 AXP2101_BLDO2_V_OUT, AXP2101_LDO_V_OUT_MASK,
		 AXP2101_LDO_ONOFF0, AXP2101_PWR_OUT_BLDO2_MASK),
	AXP_DESC(AXP2101, CPUSLDO, "cpusldo", "dcdc4", 500, 1400, 50,
		 AXP2101_CPUSLDO_V_OUT, AXP2101_LDO_V_OUT_MASK,
		 AXP2101_LDO_ONOFF0, AXP2101_PWR_OUT_CPUSLDO_MASK),
	AXP_DESC(AXP2101, DLDO1, "dldo1", "dcdc1", 500, 3300, 100,
		 AXP2101_DLDO1_V_OUT, AXP2101_LDO_V_OUT_MASK,
		 AXP2101_LDO_ONOFF0, AXP2101_PWR_OUT_DLDO1_MASK),
	AXP_DESC(AXP2101, DLDO2, "dldo2", "dcdc4", 500, 1400, 50,
		 AXP2101_DLDO2_V_OUT, AXP2101_LDO_V_OUT_MASK,
		 AXP2101_LDO_ONOFF1, AXP2101_PWR_OUT_DLDO2_MASK),
};
